                ...
                >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="https://mc-heads.net/avatar/username/100.png"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <DialogFooter>
                    <Button type="submit" disabled={createStaffMutation.isPending}>
                      {createStaffMutation.isPending ? "Guardando..." : "Guardar Miembro"}
                    </Button>
                  </DialogFooter>
                </form>
              </Form>
                ...
                >
                  ...
                  <DialogFooter>
                    <Button type="submit" disabled={updateStaffMutation.isPending}>
                      {updateStaffMutation.isPending ? "Actualizando..." : "Actualizar Miembro"}
                    </Button>
                  </DialogFooter>
                </form>
              </Form>

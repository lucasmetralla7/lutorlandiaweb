...
export const tournamentPodiums = mysqlTable("tournament_podiums", {
  id: int("id").primaryKey().autoincrement(),
...
export type TournamentRegistrationStatusType = z.infer<typeof tournamentRegistrationStatusSchema>;
...
export type InsertTournamentPodium = z.infer<typeof insertTournamentPodiumSchema>;

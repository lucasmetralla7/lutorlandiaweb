                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Ej: 18:00" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="https://ejemplo.com/evento" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
        ...
        {isLoading ? (
          ...
          announcements.map((announcement) => (
            <Card key={announcement.id}>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                          ...
                          >
                            {deleteAnnouncementMutation.isPending && deleteAnnouncementId === announcement.id ? (
                              <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                            ) : (
                              "Eliminar"
                            )}
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm font-medium mt-3 mb-1">Tipo:</p>
                    <p className="text-sm text-muted-foreground">{announcement.type}</p>
                    {announcement.link && (
                      <>
                        <p className="text-sm font-medium mt-3 mb-1">Enlace:</p>
                        <a 
              ...
              <CardFooter className="text-xs text-muted-foreground">
                ...
                Actualizado: {new Date(announcement.updatedAt).toLocaleString()}
              </CardFooter>
            </Card>
          ))
        ) : (
          <Card>
            <CardContent className="text-center py-10">
              ...
              <p className="mt-2 text-muted-foreground">Haz clic en "Nuevo Anuncio" para crear uno.</p>
            </CardContent>
          </Card>
        )}
      </div>

      {/* Diálogo para editar anuncio */}

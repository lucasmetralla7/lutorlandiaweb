      ...
      <Tabs defaultValue="categories" value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="categories" className="py-4">
          ...
          <Dialog open={isEditCategoryDialogOpen} onOpenChange={setIsEditCategoryDialogOpen}>
            <DialogContent className="<DialogContent className="<DialogContent className="<DialogContent className="<DialogContent className="sm:max-w-[500px]">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">" className="max-h-[90vh] overflow-y-auto">
              <DialogHeader>
